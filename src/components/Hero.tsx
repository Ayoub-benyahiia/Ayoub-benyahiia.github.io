...
export const Hero = () => {
  ...
  if (isLoading) {
    return (
      <section className="container pb-16 pt-10 sm:pb-20 sm:pt-12 lg:pb-28 lg:pt-20">
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="container relative pb-16 pt-10 sm:pb-20 sm:pt-12 lg:pb-28 lg:pt-20">
        <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_1fr] lg:gap-12">
          <div className="space-y-6 sm:space-y-8">
            ...
            <motion.h1
              ...
              className="max-w-5xl text-3xl font-semibold leading-[1.08] tracking-tight sm:text-5xl lg:text-6xl xl:text-7xl"
            >
            ...
            >
              <Link
                to="/contact"
                className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-accent px-5 py-3 text-sm font-medium text-accent-foreground shadow-glow transition-all duration-300 hover:scale-[1.02] hover:bg-accent-glow"
              >
                Work With Me
              ...
              <Link
                to="/projects"
                className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-border bg-surface px-5 py-3 text-sm font-medium text-foreground transition-all duration-300 hover:border-accent hover:text-accent"
              >
                View Projects
                <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
              </Link>
              ...
              {socialLinks?.map((s) => {
                ...
                return (
                  <a
                    ...
                    aria-label={s.label}
                    className="grid h-11 w-11 place-items-center rounded-full border border-border text-muted-foreground transition-all duration-300 hover:-translate-y-0.5 hover:border-accent hover:text-accent hover:shadow-glow"
                  >
            ...
            <div className="relative aspect-square">
              ...
              <div className="relative h-full w-full overflow-hidden rounded-[2rem] border border-border bg-surface-elevated shadow-elevated">
                <img
                  ...
                  loading="eager"
                  decoding="async"
                  sizes="(min-width: 1024px) 40vw, min(100vw - 2rem, 28rem)"
                  width={640}
                  height={640}
                />
        ...
        {skillNames.length > 0 && (
          <div className="relative mt-14 overflow-hidden border-y border-border/60 py-4 sm:mt-20">
            <div className="flex w-max animate-scroll-x gap-8 motion-reduce:animate-none">
