# Insights Content Plan — Ayoub Ben Yahia
...
- Freelance data analyst Morocco
- Remote data analyst workflow

## 3. Pillar Clusters

### Dashboard Creation & KPI Tracking

Focus on dashboard planning, KPI selection, Power BI, Excel reporting, stakeholder views, data preparation, and dashboard design mistakes.

### Marketing Analytics & Reporting

Focus on campaign reporting, Google Analytics, Looker Studio, content performance, channel performance, attribution basics, and marketing KPI tracking.

### Freelance Data Analytics / Morocco / Remote Work

Focus on freelance analytics workflows, working with businesses in Morocco, remote data analyst collaboration, portfolio building, briefs, delivery, and handoff.

## 4. First 12 Article Ideas
...
Use this structure for future articles:

1. Problem
2. Who it helps
3. Tools used
4. Step-by-step process
5. Example dashboard/report structure
6. Common mistakes
7. Key takeaways
8. CTA
9. Internal links
...
## 6. Medium Cross-posting Guidelines

- Publish the full article on the portfolio first when possible.
